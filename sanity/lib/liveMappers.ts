...
export function mapLiveProductsPage(initial: ProductContent, data: any): ProductContent {
  ...
  return {
    ...
    heroPrimaryHref: data.heroPrimaryHref || initial.heroPrimaryHref || '/kontakt',
    heroSecondaryLabel: data.heroSecondaryLabel || initial.heroSecondaryLabel,
    heroSecondaryHref: data.heroSecondaryHref || initial.heroSecondaryHref || '#parametre',
    introTag: data.introTag || initial.introTag,
    introTitle: data.introTitle || initial.introTitle,
    efficiencyTitleA: data.efficiencyTitleA || initial.efficiencyTitleA,
    efficiencyValueA: data.efficiencyValueA || initial.efficiencyValueA,
    efficiencyTitleB: data.efficiencyTitleB || initial.efficiencyTitleB,
    efficiencyValueB: data.efficiencyValueB || initial.efficiencyValueB,
    catalogTag: data.catalogTag || initial.catalogTag,
    ...
    dimensionsTitle: data.dimensionsTitle || initial.dimensionsTitle,
    rangeTag: data.rangeTag || initial.rangeTag,
    rangeTitle: data.rangeTitle || initial.rangeTitle,
    accessoriesTag: data.accessoriesTag || initial.accessoriesTag,
    accessoriesTitle: data.accessoriesTitle || initial.accessoriesTitle,
    certificatesTag: data.certificatesTag || initial.certificatesTag,
    certificatesTitle: data.certificatesTitle || initial.certificatesTitle,
    galleryTag: data.galleryTag || initial.galleryTag,
    galleryTitle: data.galleryTitle || initial.galleryTitle,
    galleryDescription: data.galleryDescription || initial.galleryDescription,
    videosTag: data.videosTag || initial.videosTag,
