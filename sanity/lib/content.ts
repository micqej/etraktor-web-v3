...
export const defaultProductsPage: ProductContent = {
  ...
  catalogTag: 'Dokumenty k produktom',
  catalogTitle: 'ET 2000 a ET 3000',
  catalogDescription:
    'Ilustračné PDF dokumenty a fotogaléria ku každému modelu. Obsah sekcie sa dá priebežne dopĺňať podľa dodaných podkladov.',
  productCatalog: [
    {
      ...
      highlights: [
        'Ilustračné dokumenty k produktu',
        'Fotografie modelu ET 2000',
        'Priestor na doplnenie ďalších podkladov',
      ],
      documentsTitle: 'Dokumenty ET 2000',
      documents: [
        {label: 'Cenník ET 2000', url: '/documents/et-2000-cennik.pdf'},
        {label: 'Rozmery ET 2000', url: '/documents/et-2000-rozmery.pdf'},
        {label: 'Technické parametre ET 2000', url: '/documents/et-2000-technicke-parametre.pdf'},
        {label: 'Príslušenstvo ET 2000', url: '/documents/et-2000-prislusenstvo.pdf'},
        {label: 'Certifikáty ET 2000', url: '/documents/et-2000-certifikaty.pdf'},
      ],
      ...
      galleryImages: [
        ...
        {src: '/images/dojazd2.jpg', alt: 'ET 2000 dojazd'},
      ],
    ...
    },
    {
      ...
      highlights: [
        'Samostatné dokumenty k modelu ET 3000',
        'Fotografie modelu ET 3000',
        'Priestor na doplnenie ďalších technických podkladov',
      ],
      documentsTitle: 'Dokumenty ET 3000',
      documents: [
        {label: 'Cenník ET 3000', url: '/documents/et-3000-cennik.pdf'},
        {label: 'Rozmery ET 3000', url: '/documents/et-3000-rozmery.pdf'},
        {label: 'Technické parametre ET 3000', url: '/documents/et-3000-technicke-parametre.pdf'},
        {label: 'Príslušenstvo ET 3000', url: '/documents/et-3000-prislusenstvo.pdf'},
        {label: 'Certifikáty ET 3000', url: '/documents/et-3000-certifikaty.pdf'},
      ],
      ...
      galleryImages: [
        ...
        {src: '/images/dojazd1.jpg', alt: 'ET 3000 detail'},
        {src: '/images/dojazd2.jpg', alt: 'ET 3000 dojazd'},
      ],
  ...
  dimensionsTag: 'Technické parametre',
  dimensionsTitle: 'Špecifikácie ET 2000 a ET 3000',
  dimensionImages: [
  ...
  accessoriesTag: 'Príslušenstvo',
  accessoriesTitle: 'Príslušenstvo k ET 2000 a ET 3000',
  accessories: [
    {
  ...
  comfortTitle: 'Výbava a kabína ET 2000',
  comfortItems: [
    {label: 'Odprúžené sedadlo s opierkami', type: 'štandard'},
    {label: 'Spätné zrkadlá', type: 'štandard'},
    {label: 'Informačný display', type: 'štandard'},
